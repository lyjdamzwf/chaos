...
void test_async_method()
{
    ...
    async_method_t m1 = async_method_t::bind_memfunc(&hw, &hw_t::call0);
    async_method_t m2 = async_method_t::bind_memfunc(&hw, &hw_t::call1, 123456);
    async_method_t m3 = async_method_t::bind_memfunc(&hw, &hw_t::call2, 1121, string("lyj"));
    async_method_t m4 = async_method_t::bind_memfunc(&hw, &hw_t::call3, 1121, string("lyj"), 123.456);
    async_method_t m5 = async_method_t::bind_memfunc(&hw, &hw_t::call4, 1121, string("lyj"), 123.456, string("zark"));
    async_method_t m6 = async_method_t::bind_memfunc(&hw, &hw_t::call5, 1121, string("lyj"), 123.456, string("zark"), (uint64_t)123456789);
    async_method_t m7 = async_method_t::bind_func(&test_static_func, tmp_str);
    async_method_t m8 = async_method_t::bind_func(&foo_t::test_static_func, tmp_str2);
